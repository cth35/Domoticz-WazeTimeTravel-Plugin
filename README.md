...
2. Make plugin executable
```
sudo chmod +x plugin.py
```
3. Install WazeRouteCalculator with

```
sudo pip3 install WazeRouteCalculator
```

4. Configure the plugin parameters via the Domoticz Hardware tab.

<img width="1178" height="487" alt="image" src="https://github.com/user-attachments/assets/017bf6ff-9dcf-41b6-8306-7edfd06c8c01" />

5. Restart domoticz; it creates a Domoticz custom device named "Trip" to show travel time (don't forget to allow discovering of new devices in settings).
